<?php namespace mtools\MercadoLivre;

use Illuminate\Support\ServiceProvider;
use mtools\MercadoLivre\MercadoLivre;
...
class MercadoLivreServiceProvider extends ServiceProvider
{
	...
	public function register()
	{
		$this->app->singleton('mercadolivre', function(){
			return new MercadoLivre($this->client_id, $this->client_secret, $this->urls, $this->curl_opts);
		});
			
	        $this->app->singleton('mtools\MercadoLivre\Contracts', function(){
	            return new MercadoLivre($this->client_id, $this->client_secret, $this->urls, $this->curl_opts);
	        });
	}
